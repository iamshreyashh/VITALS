...
// source: insurance/insurance/insurance.proto
...
func (m *insurance) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *insurance) GetFee() string {
	if m != nil {
		return m.Fee
	}
	return ""
...
func (m *insurance) GetCollateral() string {
	if m != nil {
		return m.Collateral
	}
	return ""
...
func (m *insurance) GetDeadline() string {
	if m != nil {
		return m.Deadline
	}
	return ""
...
func (m *insurance) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (m *insurance) GetBorrower() string {
	if m != nil {
		return m.Borrower
	}
	return ""
...
func (m *insurance) GetLender() string {
	if m != nil {
		return m.Lender
	}
	return ""
...
func init() {
	proto.RegisterType((*insurance)(nil), "insurance.insurance.insurance")
}

func init() { proto.RegisterFile("insurance/insurance/insurance.proto", fileDescriptor_c51a16ffe2d36ee8) }
...
func (m *insurance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Lender) > 0 {
		...
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Lender)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Borrower) > 0 {
		...
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Borrower)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.State) > 0 {
		i -= len(m.State)
		copy(dAtA[i:], m.State)
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.State)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Deadline) > 0 {
		...
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Deadline)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Collateral) > 0 {
		...
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Collateral)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Fee) > 0 {
		i -= len(m.Fee)
		copy(dAtA[i:], m.Fee)
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Fee)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Amount) > 0 {
		...
		i = encodeVarintinsurance(dAtA, i, uint64(len(m.Amount)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
